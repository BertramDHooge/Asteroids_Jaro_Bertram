...
public class getVXExpression implements Expression<Type> {

    private Expression<? extends Type> e;
    private SourceLocation location;

    public getVXExpression(Expression<? extends Type> e, SourceLocation location) {
        setExpression(e);
    ...
    public Type evaluate(Ship ship, Function function) throws ClassNotFoundException {
        return new doubleType(((Entity)this.getExpression().evaluate(ship, function).get()).getVelocity()[0]);
    }
